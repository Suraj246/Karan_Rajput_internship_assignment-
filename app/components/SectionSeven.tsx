...
const SectionSeven = () => {
    return (
        <div
            className="relative w-full h-auto bg-cover bg-center py-20"
            style={{
                backgroundImage: "url('/section6-images/Bg-Graphic.png')",
            }}
        >
            <div className="bg-[#F8F8F8] relative md:mt-24  w-full mx-auto px-6 md:px-16 py-12">
